    ...
    <main className="min-h-screen bg-gray-50">
      ...
      <section className="relative overflow-hidden pt-32 pb-24 px-4">
        ...
        <div className="max-w-4xl mx-auto text-center relative z-10">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="#"
              className="px-8 py-4 rounded-xl text-base font-semibold text-gray-900 bg-gradient-to-r from-yellow-400 to-amber-400 hover:from-yellow-500 hover:to-amber-500 shadow-lg hover:shadow-xl transition-all duration-200"
            >
              Start for free →
            </Link>
            <Link
      ...
      <section className="py-24 px-4">
        <div className="max-w-3xl mx-auto text-center bg-gradient-to-br from-yellow-400 to-amber-500 rounded-3xl p-12 shadow-2xl relative overflow-hidden">
          ...
          <Link
            href="#"
            className="relative z-10 inline-block px-8 py-4 rounded-xl text-base font-semibold text-yellow-800 bg-white hover:bg-yellow-50 shadow-lg hover:shadow-xl transition-all duration-200"
          >
            Get started free →
          </Link>
        </div>
